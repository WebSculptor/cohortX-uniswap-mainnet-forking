...
const main = async () => {
  ...
  console.log("--------------------IMPERSONATED SIGNER--------------------");

  console.log(impersonatedSigner);

  const amountOut = ethers.parseUnits("2000", 8);
  ...
  console.log(
    "--------------------RUNNING SWAP EXACT TOKENS FOR TOKENS SUPPORTING FEE ON TRANSFER TOKENS--------------------"
  );
